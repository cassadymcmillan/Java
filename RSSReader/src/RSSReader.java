...
public final class RSSReader {
    ...
    public static void main(String[] args) {
        ...
        // Ask for a RSS 2.0 feed
        out.println("Please enter a RSS 2.0 feed: ");
        String url = in.nextLine();

        SimpleWriter fileOut = new SimpleWriter1L("rss.html");

        // Assume the input is indeed a valid RSS 2.0 feed
        XMLTree root = new XMLTree1(url);
        // Check if it is a RSS 2.0 feed
