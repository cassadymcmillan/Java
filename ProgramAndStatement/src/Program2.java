...
public class Program2 extends ProgramSecondary {
    ...
    private void createNewRep() {
        //Define the name context and body of program
        this.name = "Unnamed";
        //Context and body are structured with map1L and statement1
    ...
    public final String replaceName(String n) {
        ...
        // Rename the name with the new one
        this.name = n;
    ...
    public final Map<String, Statement> replaceContext(
        ...
        // Store the old context in the map and clear the current one
        Map<String, Statement> oldContext = this.context.newInstance();
        oldContext.transferFrom(this.context);
        // Set the context to the target context
    ...
    public final Statement replaceBody(Statement b) {
        ...
        // Store the old body in the statement and clear the original one
        Statement oldBody = this.body.newInstance();
        oldBody.transferFrom(this.body);
        // Set the body to the target statement
